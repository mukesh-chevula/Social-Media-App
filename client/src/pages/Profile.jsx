...
const Profile = () => {
  ...
  <img src="/assets/post/1.jpeg" alt="" style={{ height: '250px' }} />
  <div className="position-relative" style={{ zIndex: '1000' }}>
    <img src="/assets/person/2.jpeg" alt="" style={{ height: '200px', width: '200px', top: '-150px' , left:'435px',zIndex:'10000'}} className='img img-fluid rounded-circle position-absolute border border-3 border-white' />
  </div>
